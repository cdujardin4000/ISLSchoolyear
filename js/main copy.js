...
$(function(){
    ...
    Student.prototype = {
        ...
        ResolveHtmlInscription : function () {
            ...
            p.append(`L'étudiant ${this.name} ${this.firstname} s'est bien inscrit à l'Institut Saint-Laurent pour l'année 
            académique 2038-2039, son email de contact est ${this.email}`)
        ...
        ResolveHtmlTable : function () {
            ...
            TARGETTITLES.css("textAlign", 'center');
            TARGETTITLES.css("color", 'blue');
        ...
        CreateHtmlTimeOut : function (AmountMs, target) {
            ...
            return new Promise(resolve => {
                setTimeout(() => {
                    if (target === "inscrition"){
                        resolve(this.ResolveHtmlInscription());
                    }
                    else if 
                    (target === "table"){
        ...
        SchoolYear : function(){
            ...
            if (this.remainingAbsence < 0){
                ...
                while (amountTests < 1);
                console.log(`indice chance: ${luckyNumber}`);
                console.log(`nombre de tests: ${amountTests}`);
                for (let nameCursus in this.cursus){                
            ...
            this.CreateHtmlTimeOut(10000, "table"); 
        },
    }
    ...
    SimulateSchoolYear = function(){
        ...
        monEtudiant.CreateHtmlTimeOut(1000, "inscription");
...
$(function(){
    ...
    Student.prototype = {
        ...
        SchoolYear : function(){
            ...
            this.CreateHtmlTimeOut(12000, "table"); 
        },
